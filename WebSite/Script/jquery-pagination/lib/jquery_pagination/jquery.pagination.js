 ...
 (function($){
	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		getLinks:function(current_page, eventHandler) {
			...
			fragment.append("<span class='current prev'>共有"+this.maxentries+"条 当前"+ (current_page+1) +"/"+ np +"</span>"); //修改，增加分页详情
			...
			//解决父系元素清除浮动的bug
			fragment.append("<div style='clear:both'></div>"); //
	...
	var containers = this,
		...
		maxentries = (!maxentries || maxentries < 0)?0:maxentries;//2010-07-13 增加 by 杜有发 修复默认值的BUG
		...
		//opts.callback(current_page, containers);//2010-07-12 注释 by 杜有发，首次render，则不需要执行callback
