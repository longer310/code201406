    ...
    <script type="text/javascript">
        ...
        var MPage = {
            init: function () {
                ...
                KindEditor.ready(function (K) {
                    ...
                    mpage.text_editor = text_editor = K.create('textarea[name="content"]', {
                        uploadJson: '../../Handler/FileManager/UploadHandler.ashx?type=2&sellerid=' + sellerId,
                    ...
                    mpage.image_editor = image_editor = K.editor({
                        uploadJson: '../../Handler/FileManager/UploadHandler.ashx?type=2&sellerid=' + sellerId,
                        fileManagerJson: '../../Handler/FileManager/FileManagerHandler.ashx?type=2&sellerid=' + sellerId,
                    });
                ...
                $("#j-activity-editForm").bind("click", function () {
                    ...
                    if (mpage.activityDetailData) {
                        ...
                        $.ajax({
                            url: "../../Handler/Backstage/ActiveHandler.ashx?action=update&id=" + activity_id,
                            data: save_data,
                            type: "POST",
                            dataType: "json"
            ...
            getActivityDetail: function (id) {
                ...
                $.ajax({
                    url: "../../Handler/Backstage/ActiveHandler.ashx?action=getitem&id=" + id,
                    type: "get",
                    dataType: "json"
                    //context: document.body
                }).success(function (data) {
                    json.result.title = data.data.title;
                    json.result.ticket.id = data.data.couponid;
                    json.result.ticket.title = data.data.coupontitle;
                    json.result.thumbnail = data.data.imgurl;
