            ...
            init: function () {
                ...
                KindEditor.ready(function (K) {
                    ...
                    mpage.image_editor = image_editor = K.editor({
                        uploadJson: '<%=DomainUrl %>/Handler/FileManager/UploadHandler.ashx?type=106&sellerid=' + sellerId,
                        fileManagerJson: '<%=DomainUrl %>/Handler/FileManager/FileManagerHandler.ashx?type=106&sellerid=' + sellerId,
                    });
                ...
                $("#j-ticket-addForm").bind("submit", function () {
                    ...
                    $.ajax({
                        url: "../../Handler/Backstage/CouponHandler.ashx?action=create&sellerid=" + sellerId,
                        data: save_data,
                        type: "POST",
                        dataType: "json"
                ...
                $("#j-ticket-addForm").bind("reset", function () {
                    ...
                    $("#j-ticket-score").val('');
                    $("#j-ticket-total").val('');
                    $("#j-ticket-discount").val('');
                    $("#j-goods-selected").html("");
