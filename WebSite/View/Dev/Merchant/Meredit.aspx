			...
			<div class="widget-box" >
				<div class="widget-content">
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="checkbox"><input type="checkbox" id="j-is_wifi"> 是否使用【易wifi】</label>
							<label class="checkbox"><input type="checkbox" id="j-is_print"> 是否使用【云打印】</label>
						</div>
					</div>
        ...
        <script type="text/javascript">
            var MPage = {
                ...
                showCategroyList: function () {
                    ...
                    $("#j-categroy-list").html($("#j-tmpl-categroy-listitem").tmpl({
