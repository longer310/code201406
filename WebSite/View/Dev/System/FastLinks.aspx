    ...
    <script type="text/javascript">
        var MPage = {
            init: function () {
                ...
                $("#j-btn-delSelected").bind("click", function () {
                    ...
                    Common.confirm({
                        ...
                        confirm: function () {
                            //执行确认回调
                            $.ajax({
                                url: "../../../Handler/Backstage/DevSystemHandler.ashx?action=delfastlinks&ids=" + ids,
                                type: "Get",
                                dataType: "json"
                    ...
                    if (data_save.length > 0) {
                        Common.confirm({
                            ...
                            confirm: function () {
                                //执行确认回调
                                $.ajax({
                                    url: "../../../Handler/Backstage/DevSystemHandler.ashx?action=createfastlinks",
                                    type: "POST",
                                    data: data_save,
                                    dataType: "json"
                                    //context: document.body
                ...
                $("#j-addForm").bind("submit", function () {
                    var save_data = {
                        ...
                        url: $.trim($("#j-url").val()),
                        imgurl: $('#j-img-placehold').attr("src")
                    }
                    $.ajax({
                        url: "../../../Handler/Backstage/DevSystemHandler.ashx?action=createfastlinks",
                        type: "POST",
            ...
            getList: function () {
                ...
                $.ajax({
                    url: "../../../Handler/Backstage/DevSystemHandler.ashx?action=getfastlinkslist&start=" + 0 + "limit=0",
                    type: "Get",
                    dataType: "json"
                    //context: document.body
                }).success(function (data) {
