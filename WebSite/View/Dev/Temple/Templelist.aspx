        ...
        <script type="text/jquery-tmpl-x" id="j-tmpl-listitem">
        	{{each(i, v) list}}
	        	<li class="item" data-id="1">
					<div class="item-in">
						<h3 class="post-title">主题名称主主题名称主题注明主题名称题注明主题名称</h3>
						<div class="article-thumb">
							<img alt="User" src="http://placehold.it/128x128" />
						</div>
						<div class="article-post" style="margin-top:10px;">
							<p>名称：<span class="text-warning">模版1</span></p> 
							<p>所属：<span class="text-warning">夜场类</span></p>
            ...
            var MPage = {
                ...
                getTempleList: function (p, type) {
                    ...
                    ue.pager({
                        ...
                        onchange: function (page) {//切换页数回调函数
                            ...
                            Route.goto("template_list.html?page=" + page + "&mid=" + mpage.mid);
                        }
                    });
                ...
                renderTab: function () {
                    ...
                    $('#j-tab a').bind("click", function (e) {
                        ...
                        Route.goto("template_list.html?page=" + 1 + "&mid=" + id);
                        return false
                    });
                },
            }
