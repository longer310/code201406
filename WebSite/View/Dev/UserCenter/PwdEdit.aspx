            ...
            init: function () {
                ...
                $("#j-sysytem-login-changepassw_form").bind("submit", function () {
                    var save_data = {
                        ...
                        confirmpassw: $("#j-sysytem-login-confirmpassw").val()
                    }
                    if (save_data.newpassw != save_data.confirmpassw) {
                        alert("两次密码输入不一致");
                        return;
                    }
                    $.ajax({
                        url: "../../../Handler/Backstage/DevSystemHandler.ashx?action=pwdedit",
                        type: "POST",
                        data: save_data,
                        dataType: "json"
